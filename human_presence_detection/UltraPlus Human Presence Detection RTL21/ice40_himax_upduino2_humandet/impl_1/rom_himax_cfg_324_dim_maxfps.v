...
// Netlist written on Tue Mar 22 11:09:13 2022
...
//
// Verilog Description of module rom_himax_cfg_324_dim_maxfps
//

module rom_himax_cfg_324_dim_maxfps (clk_i, rst_i, clk_en_i, wr_en_i, 
            wr_data_i, addr_i, rd_data_o);
    input clk_i;
    input rst_i;
    input clk_en_i;
    input wr_en_i;
