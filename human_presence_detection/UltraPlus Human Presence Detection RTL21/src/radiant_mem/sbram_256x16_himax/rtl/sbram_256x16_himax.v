...
*******************************************************************************/
module sbram_256x16_himax (wr_clk_i, rd_clk_i, wr_clk_en_i, rd_en_i,
    rd_clk_en_i, wr_en_i, wr_data_i, wr_addr_i, rd_addr_i, rd_data_o);
    input  wr_clk_i;
    input  rd_clk_i;
    input  wr_clk_en_i;
    input  rd_en_i;
    ...
    lscc_ram_dp #(.WADDR_DEPTH(256),
        ...
        .RESETMODE("sync"),
        .INIT_MODE("mem_file"),
        .INIT_FILE("misc/ram256x16_himax_sbram_256x16_himax_copy.mem"),
