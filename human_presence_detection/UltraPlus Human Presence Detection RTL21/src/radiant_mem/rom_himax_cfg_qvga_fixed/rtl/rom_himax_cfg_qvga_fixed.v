...
*******************************************************************************/
module rom_himax_cfg_qvga_fixed (clk_i, clk_en_i, wr_en_i, wr_data_i, addr_i,
    rd_data_o);
    input  clk_i;
    input  clk_en_i;
    input  wr_en_i;
    ...
    lscc_ram_dq #(.ADDR_DEPTH(256),
        ...
        .RESETMODE("sync"),
        .INIT_MODE("mem_file"),
        .INIT_FILE("misc/ram256x16_himax_fixed_rom_himax_cfg_qvga_fixed_copy.mem"),
